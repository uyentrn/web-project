...
-- CreateEnum
CREATE TYPE "ScentLayer" AS ENUM ('top', 'heart', 'base');
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductVariant_productId_sizeMl_concentration_key" ON "ProductVariant"("productId", "sizeMl", "concentration");
...
-- CreateIndex
CREATE INDEX "ProductNote_layerType_idx" ON "ProductNote"("layerType");
